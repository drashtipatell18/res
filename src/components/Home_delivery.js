...
function Home_delivery() {
    ...
    const [data, setData] = useState([
        {
            ...
            pay1: '$20.00',
            Delivery_address1:'123rd Avenue and 789th Avenue',
    ...
    return (
        <div className='b_bg_color'>
            ...
            <div className='d-flex b_bg_color '>
                <div>
                    <Sidenav />
                </div>
                    ...
                    <div className='d-flex justify-content-between me-4 b_btn_main'>
                        <div className=''>
                            <ul className="nav nav-pills b_nav ms-4 mb-3 gap-3 " id="pills-tab" role="tablist">
                                ...
                                <li className="nav-item" role="presentation">
                                    <button className="nav-link active rounded-pill" id="pills-profile-tab2" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Delivery</button>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <button className="nav-link rounded-pill" id="pills-contact-tab3" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Ratiro</button>
                                </li>
                                <li className="nav-item" role="presentation">
                            ...
                            <tbody className='text-white b_btnn '>
                                {data.map((order) => (
                                    <tr key={order.id} className='b_row'>
                                        ...
                                        <td className='b_text_w'>{order.Delivery_address}</td>
                                        <td className='b_btn1 ms-3 md-4'>{order.guy}</td>
