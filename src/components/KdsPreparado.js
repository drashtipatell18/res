...
const KdsPreparado = () => {
    ...
    const kds = useSelector(state => state.kds.kds).filter((v)=>v.status == "prepared");
                ...
                <div className="flex-grow-1 sidebar">
                    ...
                    <div className="j-kds-body">
                        <Link to={"/kds"} className='text-decoration-none'>
                            <div className={`j-kds-body-btn-2 j-kds-body-btn mx-3`}>
                                <button className='d-flex align-items-center j-kds-body-text-1'>
                                    Preparado <FaXmark className='ms-2 j-kds-body-text-1' />
                                </button>
                            </div>
                        </Link>
                        <div className="row">
