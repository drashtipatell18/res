    ...
    const [data, setData] = useState([
        {
            ...
            pay: '$20.00',
            shipping_add:'123rd Avenue and 789th street',
                    ...
                    <div className='d-flex justify-content-between me-4 b_btn_main'>
                        <div className=''>
                            <ul className="nav nav-pills b_nav ms-4 mb-3 gap-3 " id="pills-tab" role="tablist">
                                ...
                                <li className="nav-item" role="presentation">
                                    <button className="nav-link active rounded-pill" id="pills-paltform-tab5" data-bs-toggle="pill" data-bs-target="#pills-paltform" type="button" role="tab" aria-controls="pills-paltform" aria-selected="false">Plataforma</button>
                                </li>
                            </ul>
                            ...
                            <tbody className='text-white b_btnn '>
                                {data.map((order) => (
                                    <tr key={order.id} className='b_row'>
                                        ...
                                        <td className='b_btn1 b_btn_p ms-3'>{order.guy}</td>
...
export default Home_plataforma;;
